                                    ...
                                    <tbody>
                                       <?php foreach($lista as $produto): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <button type="button" onclick="window.location='produto-edita.php?id=<?php echo $produto->getIdproduto(); ?>';" class="btn btn-outline btn-primary
">Editar</button>
<button type="button" onclick="confirm('Deseja exclir este registro?') ? window.location='produto-deleta-ok.php?id=<?php echo $produto->produto(); ?>' : stop = false;" class="btn btn-outline btn-danger">Deletar</button>
                                            </td>
                                        </tr>
                                       <?php endforeach; ?>
