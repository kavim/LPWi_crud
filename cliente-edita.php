                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form role="form" action="cliente-edita-ok.php" method="POST">

                                            <input type="hidden" name="idcliente" value="<?php echo $userData->getIdcliente(); ?>" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="number" value="<?php echo $userData->getTelefone(); ?>" name="telefone" required="true">
                                            </div>
                                            <div class="form-group">
                                                <label>Saldo</label>
                                                <input class="form-control"  type="number"value="<?php echo $userData->getSaldo(); ?>" placeholder="saldo" name="saldo" required="true">
                                            </div>
