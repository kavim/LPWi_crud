                 ...
                 <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           <button type="button" onclick="window.location='cliente-lista.php'"class="btn btn-outline btn-primary">Pesquisar</button>
                           <button type="button" onclick="window.location='cliente-cadastra.php'" class="btn btn-outline btn-primary">Novo</button>
                        </div>
                        <!-- /.panel-heading -->
