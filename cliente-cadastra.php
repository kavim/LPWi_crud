                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form role="form" action="cliente-cadastra-ok.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control"  type="number"placeholder="cel" name="telefone" required="true">
                                            </div>
                                            <div class="form-group">
                                                <label>saldo</label>
                                                <input class="form-control" type="number" placeholder="saldo" name="saldo" required="true">
                                            </div>
