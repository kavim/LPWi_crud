                                    ...
                                    <div class="col-lg-6">
                                        <form role="form" action="produto-cadastra-ok.php" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label>nome </label>
                                                <input class="form-control" placeholder="Produto" name="nome" required="true">
                                            </div>

                                             <div class="form-group">
                                                <label>fornecedor</label>
                                                <input class="form-control" placeholder="fornecedor" name="fornecedor" required="true">
                                            </div>

                                             <div class="form-group">
                                                <label>Valor Custo</label>
                                                <input class="form-control" type="number" placeholder="valor Custo" name="valorCusto" required="true">
                                            </div>

                                             <div class="form-group">
                                                <label>valor Venda</label>
                                                <input class="form-control" type="number" placeholder="valor Venda" name="valorVenda" required="true">
                                            </div>
                                            <div class="form-group">
                                               <label>quantidade  estoque atual</label>
                                               <input class="form-control" type="number" placeholder="estoque Atual" name="estoqueAtual" required="true">
                                           </div>
                                           <div class="form-group">
                                              <label>Imagem</label>
                                              <input class="form-control" type="file"  name="imagem" required="true">
                                           </div>
